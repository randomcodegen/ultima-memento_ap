...
namespace Server
{
	...
	public class ItemSalesInfo
	{
		...
		public static ItemSalesInfo[] m_SellingInfo = new ItemSalesInfo[]
		{
			...
			new ItemSalesInfo( typeof(	Backgammon	),	200	,	15	,	0	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Inn	),
			...
			new ItemSalesInfo( typeof(	CheckerBoard	),	200	,	15	,	0	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Inn	),
			...
			new ItemSalesInfo( typeof(	Chessboard	),	200	,	15	,	0	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Inn	),
			...
			new ItemSalesInfo( typeof(	MahjongGame	),	200	,	0	,	0	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Inn	),
